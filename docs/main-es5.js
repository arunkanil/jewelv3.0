(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    "R7Hv": function R7Hv(module, __webpack_exports__, __webpack_require__) {
      ...
      var SearchCustomersQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\nquery($Name: String) {\n  customers(\n    where: {\n      _or: [\n        { NameOfBride_contains: $Name }\n        { NameOfFather_contains: $Name }\n        { NameOfMother_contains: $Name }\n      ]\n    }\n  ) {\n    NameOfBride\n    NameOfFather\n    NameOfMother\n    id\n  }\n}\n"])));
      var CustomersQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  query {\n    customers {\n      id\n      is_verified\n      NameOfBride\n      NameOfFather\n      NameOfMother\n      MarriageDate\n      Contact_Number_1\n      Contact_Number_2\n      MarriageMonth\n      kp_caller_assigned {\n        email\n        username\n      }\n      tele_caller_contact {\n        Name\n        id\n      }\n      created_at\n      FieldReport {\n        id\n        FinancialBackground\n        QtyOfGold\n        PreferredWeddingSet\n        PlanningForReplacementAfterWedding\n        OldGoldExchangeQty\n        NoCostEmiRequired\n        EmiTenure\n        EmiIntervals\n        TokenAdvance\n        RateAdvance\n        EnquiriesFromOthers\n        AdvancePaidToOtherJewellery\n        NumberOfNewMarriageAddress\n      }\n      Address {\n        id\n        HouseName\n        Landmark\n        locality {\n          Name\n        }\n        post_office {\n          Name\n          Pincode\n          district {\n            Name\n          }\n        }\n        GeoLocation {\n          Latitude\n          Longitude\n          GoogleMapURL\n          GoogleMapPlusCode\n        }\n      }\n    }\n  }\n"])));
      var CustomersFilterQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  query (\n    $is_verified: Boolean\n    $kp_caller_assigned_null: Boolean\n    $kp_id: ID\n    $added_by_user: ID\n    $MarriageMonth_null: Boolean\n    $MarriageDate_null: Boolean\n    $MarriageMonthOR_null: Boolean\n    $MarriageDateOR_null: Boolean\n    $MarriageDate_gte: String\n    $MarriageDate_lte: String\n    $condition: String\n  ) {\n    customers(\n      sort: $condition\n      where: {\n        is_verified: $is_verified\n        kp_caller_assigned_null: $kp_caller_assigned_null\n        kp_caller_assigned: $kp_id\n        MarriageDate_null: $MarriageDate_null\n        MarriageMonth_null: $MarriageMonth_null\n        added_by_user: $added_by_user\n        MarriageDate_gte: $MarriageDate_gte\n        MarriageDate_lte: $MarriageDate_lte\n        _or: [\n          { MarriageDate_null: $MarriageDateOR_null }\n          { MarriageMonth_null: $MarriageMonthOR_null }\n        ]\n      }\n    ) {\n      id\n      is_verified\n      NameOfBride\n      NameOfFather\n      NameOfMother\n      MarriageDate\n      Contact_Number_1\n      Contact_Number_2\n      MarriageMonth\n      kp_caller_assigned {\n        email\n        username\n      }\n      added_by_user {\n        id\n        username\n      }\n      tele_caller_contact {\n        Name\n        id\n      }\n      created_at\n      FieldReport {\n        id\n        FinancialBackground\n        QtyOfGold\n        PreferredWeddingSet\n        PlanningForReplacementAfterWedding\n        OldGoldExchangeQty\n        NoCostEmiRequired\n        EmiTenure\n        EmiIntervals\n        TokenAdvance\n        RateAdvance\n        EnquiriesFromOthers\n        AdvancePaidToOtherJewellery\n        NumberOfNewMarriageAddress\n      }\n      Address {\n        id\n        HouseName\n        Landmark\n        locality {\n          Name\n        }\n        post_office {\n          Name\n          Pincode\n          district {\n            Name\n          }\n        }\n        GeoLocation {\n          Latitude\n          Longitude\n          GoogleMapURL\n          GoogleMapPlusCode\n        }\n      }\n    }\n  }\n"])));
      var CustomerSingleQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  query ($id: ID!) {\n    customer(id: $id) {\n      id\n      is_verified\n      NameOfBride\n      NameOfFather\n      NameOfMother\n      Contact_Number_1\n      Contact_Number_2\n      MarriageDate\n      MarriageMonth\n      tele_caller_contact {\n        Name\n        id\n      }\n      kp_caller_assigned {\n        email\n        username\n      }\n      created_at\n      FieldReport {\n        id\n        FinancialBackground\n        QtyOfGold\n        PreferredWeddingSet\n        PlanningForReplacementAfterWedding\n        OldGoldExchangeQty\n        NoCostEmiRequired\n        EmiTenure\n        EmiIntervals\n        TokenAdvance\n        RateAdvance\n        EnquiriesFromOthers\n        AdvancePaidToOtherJewellery\n        NumberOfNewMarriageAddress\n        images {\n          name\n          url\n          previewUrl\n        }\n        location {\n          Latitude\n          Longitude\n          GoogleMapURL\n          GoogleMapPlusCode\n        }\n      }\n      Address {\n        id\n        HouseName\n        Landmark\n        locality {\n          Name\n        }\n        post_office {\n          Name\n          Pincode\n          district {\n            Name\n          }\n        }\n        GeoLocation {\n          Latitude\n          Longitude\n          GoogleMapURL\n          GoogleMapPlusCode\n        }\n      }\n      isSaleClosed\n      CustomerStatus\n      sale_closed_by {\n        id\n        email\n        username\n      }\n      sale_closed_date\n      sale_remarks\n      TelecallerRemarks {\n        RemarksText\n        CallHistory {\n          event_date_time\n          users_permissions_user {\n            username\n            email\n          }\n        }\n      }\n    }\n  }\n"])));
      var AddCustomerMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  mutation (\n    $NameOfBride: String!\n    $NameOfFather: String!\n    $NameOfMother: String!\n    $Contact_Number_1: String!\n    $Contact_Number_2: String!\n    $MarriageDate: Date!\n    $MarriageMonth: Int!\n    $tele_caller_contact: ID!\n    $HouseName: String!\n    $Landmark: String!\n    $locality: ID!\n    $added_by_user: ID!\n    $post_office: ID\n    $Latitude: Float\n    $Longitude: Float\n    $GoogleMapURL: String\n    $GoogleMapPlusCode: String\n  ) {\n    createCustomer(\n      input: {\n        data: {\n          NameOfBride: $NameOfBride\n          NameOfFather: $NameOfFather\n          NameOfMother: $NameOfMother\n          MarriageDate: $MarriageDate\n          MarriageMonth: $MarriageMonth\n          Contact_Number_1: $Contact_Number_1\n          Contact_Number_2: $Contact_Number_2\n          tele_caller_contact: $tele_caller_contact\n          added_by_user: $added_by_user\n          Address: {\n            HouseName: $HouseName\n            Landmark: $Landmark\n            locality: $locality\n            post_office: $post_office\n            GeoLocation: {\n              Latitude: $Latitude\n              Longitude: $Longitude\n              GoogleMapURL: $GoogleMapURL\n              GoogleMapPlusCode: $GoogleMapPlusCode\n            }\n          }\n        }\n      }\n    ) {\n      customer {\n        id\n        NameOfBride\n        NameOfFather\n        NameOfMother\n        MarriageDate\n        MarriageMonth\n        Contact_Number_1\n        Contact_Number_2\n        tele_caller_contact {\n          Name\n          id\n        }\n        created_at\n        Address {\n          id\n          HouseName\n          Landmark\n          locality {\n            Name\n          }\n          post_office {\n            Name\n            Pincode\n            district {\n              Name\n            }\n          }\n          GeoLocation {\n            Latitude\n            Longitude\n            GoogleMapURL\n          }\n        }\n      }\n    }\n  }\n"])));
      var UpdateCustomerMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  mutation (\n    $id: ID!\n    $sale_remarks: String!\n    $sale_closed_date: DateTime!\n    $CustomerStatus: String\n    $isSaleClosed: Boolean\n    $sale_closed_by: ID\n  ) {\n    updateCustomer(\n      input: {\n        where: { id: $id }\n        data: {\n          CustomerStatus: $CustomerStatus\n          isSaleClosed: $isSaleClosed\n          sale_remarks: $sale_remarks\n          sale_closed_date: $sale_closed_date\n          sale_closed_by: $sale_closed_by\n          kp_caller_assigned: null\n        }\n      }\n    ) {\n      customer {\n        id\n        NameOfBride\n        NameOfFather\n      }\n    }\n  }\n"])));
      var AddCustomerCommentMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  mutation (\n    $id: ID!\n    $remarks: String!\n    $date: DateTime!\n    $is_verified: Boolean\n  ) {\n    updateCustomer(\n      input: {\n        where: { id: $id }\n        data: {\n          TelecallerRemarks: {\n            RemarksText: $remarks\n            CallHistory: { event_date_time: $date }\n          }\n          last_called_time: $date\n          is_verified: $is_verified\n        }\n      }\n    ) {\n      customer {\n        id\n        is_verified\n        NameOfBride\n        NameOfFather\n        NameOfMother\n        MarriageDate\n        MarriageMonth\n        last_called_time\n        tele_caller_contact {\n          Name\n          id\n        }\n        created_at\n        Address {\n          id\n          HouseName\n          Landmark\n          locality {\n            Name\n          }\n          post_office {\n            Name\n            Pincode\n            district {\n              Name\n            }\n          }\n          GeoLocation {\n            Latitude\n            Longitude\n            GoogleMapURL\n          }\n        }\n      }\n    }\n  }\n"])));
      var SetKpCallerMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  mutation ($id: ID!, $cust_id: [ID!]!) {\n    updateUser(input: { where: { id: $id }, data: { kp_customer: $cust_id } }) {\n      user {\n        id\n        kp_customer {\n          id\n          NameOfBride\n          NameOfFather\n        }\n      }\n    }\n  }\n"])));
      var SetTeleCallerMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  mutation ($id: ID!, $cust_id: [ID!]!) {\n    updateUser(\n      input: { where: { id: $id }, data: { tele_caller_contacts: $cust_id } }\n    ) {\n      user {\n        id\n        tele_caller_contacts {\n          id\n          Name\n          Contact_Number_1\n          Email\n        }\n      }\n    }\n  }\n"])));
      var SetFieldAgentMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  mutation ($id: ID!, $cust_id: [ID!]!) {\n    updateUser(input: { where: { id: $id }, data: { customers: $cust_id } }) {\n      user {\n        id\n        customers {\n          NameOfBride\n          id\n          NameOfFather\n          MarriageDate\n        }\n      }\n    }\n  }\n"])));
      var UsersQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  query ($type: String!) {\n    users(where: { UserType: $type }) {\n      id\n      username\n      email\n      role {\n        id\n        name\n        type\n      }\n      UserType\n    }\n  }\n"])));
      var AddCustomerEnquiry = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  mutation (\n    $Name: String!\n    $PhoneNumber: String!\n    $isWeddingPurchase: Boolean!\n    $MarriageDate: Date!\n    $QtyOfGold: Int!\n    $OptNoCostEMI: Boolean!\n    $HouseName: String!\n    $Landmark: String!\n    $PostOfficeNumber: Long!\n  ) {\n    createCustomerEnquiry(\n      input: {\n        data: {\n          Name: $Name\n          PhoneNumber: $PhoneNumber\n          isWeddingPurchase: $isWeddingPurchase\n          MarriageDate: $MarriageDate\n          QtyOfGold: $QtyOfGold\n          OptNoCostEMI: $OptNoCostEMI\n          HouseName: $HouseName\n          Landmark: $Landmark\n          PostOfficeNumber: $PostOfficeNumber\n        }\n      }\n    ) {\n      customerEnquiry {\n        id\n        Name\n        PhoneNumber\n        isWeddingPurchase\n        MarriageDate\n        QtyOfGold\n        OptNoCostEMI\n        HouseName\n        Landmark\n        PostOfficeNumber\n      }\n    }\n  }\n"])));
      var EnquiriesQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  query {\n    customerEnquiries {\n      id\n      Name\n      PhoneNumber\n      HouseName\n      Landmark\n      PostOfficeNumber\n      isWeddingPurchase\n      MarriageDate\n      QtyOfGold\n      OptNoCostEMI\n    }\n  }\n"])));
      var SingleEnquiryQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  query ($id: ID!) {\n    customerEnquiry(id: $id) {\n      id\n      Name\n      PhoneNumber\n      HouseName\n      Landmark\n      PostOfficeNumber\n      isWeddingPurchase\n      MarriageDate\n      QtyOfGold\n      OptNoCostEMI\n    }\n  }\n"])));
      var deleteEnquiry = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  mutation ($id: ID!) {\n    deleteCustomerEnquiry(input: { where: { id: $id } }) {\n      customerEnquiry {\n        Name\n        PhoneNumber\n        HouseName\n        Landmark\n      }\n    }\n  }\n"])));
      ...
      var DataService = /*#__PURE__*/function () {
        ...
        _createClass(DataService, [{
          ...
          key: "getSearchCustomers",
          value: function getSearchCustomers(searchText) {
            return this.apollo.watchQuery({
